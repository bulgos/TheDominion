...
namespace the_Dominion.Conics.Components
{
    public class ParabolaFromFourPointsComponent : GH_Component
    {
        ...
        {
            pManager.AddPointParameter("P1", "p1", "First point on the Parabola", GH_ParamAccess.item, new Point3d(-4, 4, 0));
            pManager.AddPointParameter("P2", "p2", "Second point on the Parabola", GH_ParamAccess.item, new Point3d(-3, 2, 0));
            pManager.AddPointParameter("P3", "p3", "Third point on the Parabola", GH_ParamAccess.item, new Point3d(0, 0, 0));
            pManager.AddPointParameter("P4", "p4", "Fourth point on the Parabola", GH_ParamAccess.item, new Point3d(3, 1, 0));
        }
